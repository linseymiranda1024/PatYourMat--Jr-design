  ...
  Future<void> _submitReservation(
    ...
    try {
      ...
      if (sendInvites && _selectedInviteeUids.isNotEmpty) {
        ...
        final groupResult = await DBReservations.registerForClassWithGroupInvites(
                                        ...
                                        return Row(
                                          ...
                                          children: entry.value.map((
                                            ...
                                            final isReserved = reservedMats
                                                .contains(matNumber);
                                            final isSelected =
                                                _selectedMats.contains(matNumber);
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    _selectedInviteeUids.isEmpty
                                        ? 'No friends selected for this group yet'
                                ...
                                TextButton.icon(
                                  onPressed: _isSubmitting ? null : _openInviteSheet,
                                ...
                                onPressed:
                                    ...
                                    : () async {
                                        if (gClass.filled >= gClass.capacity) {
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            const SnackBar(
                                              content: Text('Class just filled up'),
                                            ),
                                          );
                                          return;
                                        }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Choose friends now, then pick the group mat you want to book for yourself.',
              style: textTheme.bodyMedium?.copyWith(
                ...
                builder: (context, friendsSnapshot) {
                  ...
                  if (friendIds.isEmpty) {
                    return Container(
                      ...
                      child: Text(
                        'Follow a few people first, then you can invite them to join from this screen.',
                        style: textTheme.bodyMedium?.copyWith(
                          color: colorScheme.onSurfaceVariant,
                          height: 1.4,
                        ),
